...
def calculo_angulos_del_triangulo(a, b, c):
    ...
    AnguloC = math.degrees(math.acos((b**2 + a**2 - c**2) / (2*a*b)))
...
longitudes de la base y altura deben ser mayores que cero.")
                    ...
                    print(f"El área del paralelogramo de base {base}cm y altura \
{altura}cm, es: {resultado}cm²")
# ÁREA ROMBO
            elif figura == 4:
...
longitudes de la base y altura deben ser mayores que cero.") 
                    ...
                    print(f"El perímetro del rectángulo de base {base}cm y altura \
{altura}cm es: {perimetro}cm")
# PERÍMETRO TRIÁNGULO
            elif dibujo == 2:
                lado1 = float(input("Ingrese el lado 1 en cm: "))
                lado2 = float(input("Ingrese el lado 2 en cm: "))
...
# PERÍMETRO PARALELOGRAMO
                ...
                lado_base = float(input("Ingrese la base del paralelogramo en cm: "))
...
longitudes de los lados deben ser mayores que cero.")
                    ...
                    print(f"El perímetro del paralelogramo de lados {lado_base}cm \
y {lado_lateral}cm es: {perimetro}cm")
# PERÍMETRO ROMBO
            elif dibujo == 4:
...
primer y segundo lado debe ser mayor que el tercer lado ingresado.")
                ...
                AnguloA, AnguloB, AnguloC = calculo_angulos_del_triangulo(lado1, \
lado2, lado3)
            ...
            print("Fin del programa, esperamos te haya sido útil. ¡Hasta luego!.")
            break
        else:
            print("Opción no válida. Intente de nuevo.")
    except ValueError:
        print("CUIDADO: Entrada NO VALIDA.. Revisá las medidas e ingresá solo números.")
